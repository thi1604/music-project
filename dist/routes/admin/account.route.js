...
route.post("/create", upload.single("avatar"), uploadCloud_middlewares_1.uploadtoCloud, controller.createPost);
route.patch("/delete/:id", controller.deleteItem);
exports.routeAccount = route;
